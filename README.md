...
Construction Consultant will also be usefull for those looking for someone with more knowledge in the building field and that are able to offer services where a person can follow along, give advice, and keep a good eye on the project itself. 
 ...
 Live <a href="https://tjoalex.github.io/constructionconsultant/">website</a>
...
* Our team section 
  * After creating the circle images for the "Our team" section I noticed that they didn't show too well and was pretty hard to see. It wasn't until one person reviewed my code on slack that I goth the good advice to make the image to a square instead of a rectangel on photoshop (as the original images of the persons was). I did as adviced and the pictures then looked good again even when making them round. This could also be solved with change of width and height yet for now this was my solution. 
  * The other Issue with this section was that on smaller screens the header for this section moved to the left of the page insted of staying in the center. Yet after a long time of struggle I realised that I had a typo and the problem could then be solved. 
...
* After letting my code be reviewed by some members of slack I was told that the contact image and info in about page wasn't centered. Something I been aware of especially with the contact card section for both the home and about page, unfortunately I haven't found a solution and had to leave that issue for now. 
* I Worked hard to make sure that all my headers stayed center of the pages (Unless they as on the two columns sections wasn't supposed to), yet it seems like something isn't working with me on my about page the "Our team" section. Sometimes the header stays in the center and other times it doesn't, one bug I surely would like to fix when having more time.  
